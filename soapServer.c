...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.140 2026-03-31 03:39:01 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_request(struct soap *soap)
{
	...
	if (!soap_match_tag(soap, soap->tag, "tds:GetUserRoles"))
		return soap_serve___tds__GetUserRoles(soap);
	if (!soap_match_tag(soap, soap->tag, "tds:SetUserRole"))
		return soap_serve___tds__SetUserRole(soap);
	if (!soap_match_tag(soap, soap->tag, "tds:DeleteUserRole"))
		return soap_serve___tds__DeleteUserRole(soap);
	...
	if (!soap_match_tag(soap, soap->tag, "tds:UpgradeFirmware"))
		return soap_serve___tds__UpgradeFirmware(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tds__GetUserRoles(struct soap *soap)
{	struct __tds__GetUserRoles soap_tmp___tds__GetUserRoles;
	struct _tds__GetUserRolesResponse tds__GetUserRolesResponse;
	soap_default__tds__GetUserRolesResponse(soap, &tds__GetUserRolesResponse);
	soap_default___tds__GetUserRoles(soap, &soap_tmp___tds__GetUserRoles);
	if (!soap_get___tds__GetUserRoles(soap, &soap_tmp___tds__GetUserRoles, "-tds:GetUserRoles", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tds__GetUserRoles(soap, soap_tmp___tds__GetUserRoles.tds__GetUserRoles, &tds__GetUserRolesResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize__tds__GetUserRolesResponse(soap, &tds__GetUserRolesResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tds__GetUserRolesResponse(soap, &tds__GetUserRolesResponse, "tds:GetUserRolesResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tds__SetUserRole(struct soap *soap)
{	struct __tds__SetUserRole soap_tmp___tds__SetUserRole;
	struct _tds__SetUserRoleResponse tds__SetUserRoleResponse;
	soap_default__tds__SetUserRoleResponse(soap, &tds__SetUserRoleResponse);
	soap_default___tds__SetUserRole(soap, &soap_tmp___tds__SetUserRole);
	if (!soap_get___tds__SetUserRole(soap, &soap_tmp___tds__SetUserRole, "-tds:SetUserRole", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tds__SetUserRole(soap, soap_tmp___tds__SetUserRole.tds__SetUserRole, &tds__SetUserRoleResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize__tds__SetUserRoleResponse(soap, &tds__SetUserRoleResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tds__SetUserRoleResponse(soap, &tds__SetUserRoleResponse, "tds:SetUserRoleResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tds__DeleteUserRole(struct soap *soap)
{	struct __tds__DeleteUserRole soap_tmp___tds__DeleteUserRole;
	struct _tds__DeleteUserRoleResponse tds__DeleteUserRoleResponse;
	soap_default__tds__DeleteUserRoleResponse(soap, &tds__DeleteUserRoleResponse);
	soap_default___tds__DeleteUserRole(soap, &soap_tmp___tds__DeleteUserRole);
	if (!soap_get___tds__DeleteUserRole(soap, &soap_tmp___tds__DeleteUserRole, "-tds:DeleteUserRole", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tds__DeleteUserRole(soap, soap_tmp___tds__DeleteUserRole.tds__DeleteUserRole, &tds__DeleteUserRoleResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize__tds__DeleteUserRoleResponse(soap, &tds__DeleteUserRoleResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tds__DeleteUserRoleResponse(soap, &tds__DeleteUserRoleResponse, "tds:DeleteUserRoleResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve___tds__UpgradeFirmware(struct soap *soap)
{	struct __tds__UpgradeFirmware soap_tmp___tds__UpgradeFirmware;
	struct _tds__UpgradeFirmwareResponse tds__UpgradeFirmwareResponse;
	soap_default__tds__UpgradeFirmwareResponse(soap, &tds__UpgradeFirmwareResponse);
	soap_default___tds__UpgradeFirmware(soap, &soap_tmp___tds__UpgradeFirmware);
	if (!soap_get___tds__UpgradeFirmware(soap, &soap_tmp___tds__UpgradeFirmware, "-tds:UpgradeFirmware", NULL))
		return soap->error;
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = __tds__UpgradeFirmware(soap, soap_tmp___tds__UpgradeFirmware.tds__UpgradeFirmware, &tds__UpgradeFirmwareResponse);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = NULL; /* use SOAP literal style */
	soap_serializeheader(soap);
	soap_serialize__tds__UpgradeFirmwareResponse(soap, &tds__UpgradeFirmwareResponse);
	if (soap_begin_count(soap))
		return soap->error;
	if ((soap->mode & SOAP_IO_LENGTH))
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tds__UpgradeFirmwareResponse(soap, &tds__UpgradeFirmwareResponse, "tds:UpgradeFirmwareResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
