/* soapClient.c
   Generated by gSOAP 2.8.140 for ../onvif_head/onvif.h
...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.140 2026-03-31 03:39:01 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___tds__GetUserRoles(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__GetUserRoles *tds__GetUserRoles, struct _tds__GetUserRolesResponse *tds__GetUserRolesResponse)
{	if (soap_send___tds__GetUserRoles(soap, soap_endpoint, soap_action, tds__GetUserRoles) || soap_recv___tds__GetUserRoles(soap, tds__GetUserRolesResponse))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send___tds__GetUserRoles(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__GetUserRoles *tds__GetUserRoles)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv___tds__GetUserRoles(struct soap *soap, struct _tds__GetUserRolesResponse *tds__GetUserRolesResponse)
{
	if (!tds__GetUserRolesResponse)
		return soap_closesock(soap);
	soap_default__tds__GetUserRolesResponse(soap, tds__GetUserRolesResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get__tds__GetUserRolesResponse(soap, tds__GetUserRolesResponse, "tds:GetUserRolesResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___tds__SetUserRole(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__SetUserRole *tds__SetUserRole, struct _tds__SetUserRoleResponse *tds__SetUserRoleResponse)
{	if (soap_send___tds__SetUserRole(soap, soap_endpoint, soap_action, tds__SetUserRole) || soap_recv___tds__SetUserRole(soap, tds__SetUserRoleResponse))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send___tds__SetUserRole(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__SetUserRole *tds__SetUserRole)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv___tds__SetUserRole(struct soap *soap, struct _tds__SetUserRoleResponse *tds__SetUserRoleResponse)
{
	if (!tds__SetUserRoleResponse)
		return soap_closesock(soap);
	soap_default__tds__SetUserRoleResponse(soap, tds__SetUserRoleResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get__tds__SetUserRoleResponse(soap, tds__SetUserRoleResponse, "tds:SetUserRoleResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___tds__DeleteUserRole(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__DeleteUserRole *tds__DeleteUserRole, struct _tds__DeleteUserRoleResponse *tds__DeleteUserRoleResponse)
{	if (soap_send___tds__DeleteUserRole(soap, soap_endpoint, soap_action, tds__DeleteUserRole) || soap_recv___tds__DeleteUserRole(soap, tds__DeleteUserRoleResponse))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send___tds__DeleteUserRole(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__DeleteUserRole *tds__DeleteUserRole)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv___tds__DeleteUserRole(struct soap *soap, struct _tds__DeleteUserRoleResponse *tds__DeleteUserRoleResponse)
{
	if (!tds__DeleteUserRoleResponse)
		return soap_closesock(soap);
	soap_default__tds__DeleteUserRoleResponse(soap, tds__DeleteUserRoleResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get__tds__DeleteUserRoleResponse(soap, tds__DeleteUserRoleResponse, "tds:DeleteUserRoleResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call___tds__UpgradeFirmware(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__UpgradeFirmware *tds__UpgradeFirmware, struct _tds__UpgradeFirmwareResponse *tds__UpgradeFirmwareResponse)
{	if (soap_send___tds__UpgradeFirmware(soap, soap_endpoint, soap_action, tds__UpgradeFirmware) || soap_recv___tds__UpgradeFirmware(soap, tds__UpgradeFirmwareResponse))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send___tds__UpgradeFirmware(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct _tds__UpgradeFirmware *tds__UpgradeFirmware)
...
SOAP_FMAC5 int SOAP_FMAC6 soap_recv___tds__UpgradeFirmware(struct soap *soap, struct _tds__UpgradeFirmwareResponse *tds__UpgradeFirmwareResponse)
{
	if (!tds__UpgradeFirmwareResponse)
		return soap_closesock(soap);
	soap_default__tds__UpgradeFirmwareResponse(soap, tds__UpgradeFirmwareResponse);
	if (soap_begin_recv(soap)
	 || soap_envelope_begin_in(soap)
	 || soap_recv_header(soap)
	 || soap_body_begin_in(soap))
		return soap_closesock(soap);
	soap_get__tds__UpgradeFirmwareResponse(soap, tds__UpgradeFirmwareResponse, "tds:UpgradeFirmwareResponse", NULL);
	if (soap->error)
		return soap_recv_fault(soap, 0);
	if (soap_body_end_in(soap)
	 || soap_envelope_end_in(soap)
